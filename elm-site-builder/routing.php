<?
  ...
  function processRoutes() {
    route('GET', '/elm-site-builder/file/ls', function() { ls($_GET['dir']); });
    route('POST', '/elm-site-builder/file/upload', function() { upload($_POST['dir'], $_FILES['file']); });
    route('POST', '/elm-site-builder/file/newDir', function() { newDir($_POST['dir'], $_POST['newDir']); });
    route('POST', '/elm-site-builder/file/rename', function() { rename_($_POST['dir'], $_POST['oldName'], $_POST['newName']); });
    route('POST', '/elm-site-builder/file/move', function() { move($_POST['srcDir'], explode(",", $_POST['files']), $_POST['dstDir']); });
    route('POST', '/elm-site-builder/file/delete', function() { delete_($_POST['dir'], explode(",", $_POST['files'])); });

    route('GET', '/elm-site-builder/thumb', function() { thumb($_GET['image']); });
  }
  ...
  function thumb($image) {
    $thumb = "/elm-file-manager/static" . $image;
