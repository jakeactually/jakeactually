<?
  ...
  function processRoutes() {
    route('GET', '/elm-file-manager/file/ls', function() { ls($_GET['dir']); });
    route('POST', '/elm-file-manager/file/upload', function() { upload($_POST['dir'], $_FILES['file']); });
    route('POST', '/elm-file-manager/file/newDir', function() { newDir($_POST['dir'], $_POST['newDir']); });
    route('POST', '/elm-file-manager/file/rename', function() { rename_($_POST['dir'], $_POST['oldName'], $_POST['newName']); });
    route('POST', '/elm-file-manager/file/move', function() { move($_POST['srcDir'], explode(",", $_POST['files']), $_POST['dstDir']); });
    route('POST', '/elm-file-manager/file/delete', function() { delete_($_POST['dir'], explode(",", $_POST['files'])); });

    route('GET', '/elm-file-manager/thumb', function() { thumb($_GET['image']); });
  }
